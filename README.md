...
* The website pattern follow the "SSR" pattern (server side rendering) and we have contributed directly to SEO optimization, for example, including meta description (e.g., "head" specifications of the pages with "title", "initial-scale" etc.).
